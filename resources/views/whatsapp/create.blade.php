    ...
    <div class="card">
        ...
        <form method="POST" action="{{ route('servis.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    <label>Pola / PIN / Password HP</label>
                    <input type="text" name="password_hp" class="form-input" placeholder="Contoh: 123456 / Pola: 1-2-5-8">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group" style="margin-top:16px">
                ...
                <input type="text" class="form-input" value="{{ $nextKode }}" readonly style="background:#f8fafc;font-weight:700;color:var(--primary)">
            </div>
    ...
    <div>
        <div class="card">
            ...
            <ul style="font-size:.84rem;color:#64748b;line-height:2;padding-left:16px">
                ...
                <li>Tracking IMEI & Pola/Password perangkat</li>
...
function pilihPelanggan(select) {
    ...
    if (opt.value) {
        ...
        // Jangan kosongkan field, biar user bisa ketik manual
    }
}
...
// ===== CRITICAL: Strip empty sparepart inputs before submit =====
